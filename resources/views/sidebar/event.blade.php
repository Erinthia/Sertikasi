...
<body>
    ...
    <div class="events-section">
        ...
        <ul>
            <li class="list-group-item"><a href="#" class="text-decoration-none">Turing Amal untuk Rumah Sakit Anak -
            ...
            <li class="list-group-item"><a href="#" class="text-decoration-none">Turing Musim Panas ke Bali - 5
                    Maret 2025</a></li>
            <li class="list-group-item"><a href="#" class="text-decoration-none">Rapat Anggota Bulanan - 20 Maret
                    2025</a></li>
